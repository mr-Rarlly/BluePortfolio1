            ...
            >
              <div className=" flex">
                ...
                <div className="flex flex-col gap-x-4 md:flex-col mb:items-center">
                  ...
                  >
                    man I&lsquo;m not gay but I love you for what you did. thank
              ...
              <div className=" flex">
                ...
                <div className="flex flex-col gap-x-4 md:flex-col mb:items-center">
                  ...
                  >
                    ...
                    time! I&lsquo;ve never been much of a JS person, it&lsquo;s always so
              ...
              <div className=" flex">
                ...
                <div className="flex flex-col gap-x-4 md:flex-col mb:items-center">
                  ...
                  <p
                    className={`mb-6 font-[200] font-recoletablack min-h-[70px] text-[15px] mt-3`}
                  >
                    This is great do-along lecture course that doesn&lsquo;t stall
