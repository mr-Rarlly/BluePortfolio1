      ...
      >
        <div className="container m-auto">
          ...
          <h4 className="relative w-full font-[300] md:w-3/4 lg:w-2/3 xl:w-1/2 font-recoleta text-[#223740] text-2xl mb-10 px-5 md:px-24">
            Knack of Building a world You Imagined
          </h4>
          <section className="relative flex flex-col lg:flex-row px-5 md:px-24">
            ...
            >
              {" "}
              My name is Saleh. Creative and highly skilled 3D artist with a
              passion for bringing imaginative concepts to life through 3D
              modeling, texturing, and animation. Proven expertise in creating
              visually stunning assets for games, films, and interactive media.
              Strong proficiency in industry-standard software and a track
              record of collaborating on successful projects. Committed to
              delivering high-quality, innovative 3D content that captivates
              audiences
            </p>
            <p
              className={`w-full lg:w-1/3 text-[#223740] mr-0 mb-5  lg:mr-4 font-[200] ${hind.className}`}
            >
              {" "}
              Accustomed to working well with others and committed to meeting
              deadlines and adhering to project guidelines.
            </p>
            <p
              className={`w-full lg:w-1/3 text-[#223740] mr-0 mb-5  lg:mr-4 font-[200] ${hind.className}`}
            >
              {" "}
              Adept at working independently and collaboratively on projects,
              and committed to achieving visual innovation and beauty. Bringing
              forth the ability to work well with others and utilize my art
              skills to visually enhance projects.
            </p>
          </section>
        </div>
      </div>
