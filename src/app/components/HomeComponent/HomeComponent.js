      ...
      >
        <div className="container m-auto ">
          <div className="grid grid-cols-12 ">
            <div className=" bg-white  flex flex-col justify-center col-span-12 md:col-span-5  md:bg-transparent">
              <div className="container m-auto">
                <div className="lg:pl-24 sm:pl-10 pl-0 md:py-0 py-20 md:text-start text-center">
                  ...
                  >
                    3D Artist &amp; Motion Graphic &amp; Animator
                  </h2>
            ...
            <div className="md:col-span-7 col-span-12 md:pt-[130px] pt-[50px] md:bg-transparent bg-[#d9eef7] relative">
              <div className="m-auto container"
              >
                <img
                  className="container top-10 right-16"
                  alt="Saleh Amin Logo"
                  src="https://i.imgur.com/NKcB78v.png"
                  decoding="async"
                  data-nimg="intrinsic"
                ></img>
              </div>
            ...
            <div className="px-3">
              ...
              >
                <div className="lg:py-10  md:py-6 cursor-all-scroll">
                  <Slider {...settings}>
                    <img src="/AI.png" alt="" className="h-12  " />
                    <img src="/C4D.png" alt="" className=" h-12  " />
                    <img src="/AE.png" alt="" className="h-12   " />
                    <img src="/Grassshopper.png" alt="" className="h-12  " />
                    <img src="/PS.png" alt="" className="h-12  " />
                    <img src="/Rhino.png" alt="" className=" h-12  " />
                    <img src="/Unreal edited.png" alt="" className="h-12  " />
